    ...
    <div className='left'>
      ...
      <div>
        ...
        <div>
          ...
          <p>
            Collection, maintenance and verification of insurance and medical data to ensure fulfillment of Medicaid and Medicare programs assistance for eligible patients. Experience medical insurance verification systems (ie. Emdeon office, Florida Medicaid, Flimmis), Cerner Powerchart Electronic
            Medical Records (EMR) system, Protected Health Information (PHI), Personal Identifiable Information (PII), Personnel Transaction Identifier (PTI), and Health Insurance Portability and Accountability Act (HIPAA).{' '}
          </p>
        </div>
        <br />
        <div>
